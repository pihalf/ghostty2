...
in
  stdenv.mkDerivation (finalAttrs: {
    ...
    deps = callPackage ../build.zig.zon.nix {name = "ghostty2-cache-${finalAttrs.version}";};
    ...
    postInstall = ''
      terminfo_src=${
        ...
        then ''"$out/Applications/Ghostty2.app/Contents/Resources/terminfo"''
      ...
      mv "$out/share/ghostty2/shell-integration" "$shell_integration/shell-integration"
      ln -sf "$shell_integration/shell-integration" "$out/share/ghostty2/shell-integration"
    ...
    meta = {
      ...
      homepage = "https://github.com/pihalf/ghostty2";
      license = lib.licenses.mit;
      platforms = [
        "x86_64-linux"
        "aarch64-linux"
      ];
      mainProgram = "ghostty2";
    };
  })
