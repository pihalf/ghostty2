...
class DockTilePlugin: NSObject, NSDockTilePlugIn {
    ...
    #if DEBUG
    private let ghosttyUserDefaults = UserDefaults(suiteName: "io.github.pihalf.ghostty2.debug")
    #else
    private let ghosttyUserDefaults = UserDefaults(suiteName: "io.github.pihalf.ghostty2")
    #endif
