% GHOSTTY2(5) Version @@VERSION@@ | Ghostty² terminal emulator configuration file

# NAME

**ghostty2** - Ghostty² terminal emulator configuration file
...
executing the command `ghostty2 +show-config --default --docs`. Note that this will
...
You can also view the full configuration Ghostty² is loading using `ghostty2
...
`journald` to see Ghostty²'s logs: `journalctl --user --unit app-io.github.pihalf.ghostty2.service`.
